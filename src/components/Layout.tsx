        ...
        <nav className="max-w-md mx-auto flex justify-between">
          <Link
            ...
            className={`flex flex-col items-center p-2 ${
              location.pathname === '/' ? 'text-nutritrack-teal' : 'text-gray-400'
            }`}
          >
            <Home size={22} />
          ...
          <Link
            to="/add-food"
            className={`flex flex-col items-center p-2 ${
              location.pathname === '/add-food' ? 'text-nutritrack-teal' : 'text-gray-400'
            }`}
          >
          ...
          <Link
            to="/profile"
            className={`flex flex-col items-center p-2 ${
              location.pathname === '/profile' ? 'text-nutritrack-teal' : 'text-gray-400'
            }`}
          >
            <User size={22} />
